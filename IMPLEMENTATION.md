...
```powershell
cd D:/AIA/Day26-2A202600666-HoangAnhThu-main/implementation
...
```json
{
  "mcpServers": {
    "sqlite-lab": {
      "type": "stdio",
      "command": "py",
      "args": ["-3.11", "D:/AIA/Day26-2A202600666-HoangAnhThu-main/implementation/mcp_server.py"]
    }
  }
}
```
...
```powershell
gemini mcp add sqlite-lab py -3.11 D:/AIA/Day26-2A202600666-HoangAnhThu-main/implementation/mcp_server.py --description "SQLite lab FastMCP server" --timeout 10000
gemini mcp list
```
...
- Insert a student named Hoang Anh Thu in cohort A1 with score 93.5.
